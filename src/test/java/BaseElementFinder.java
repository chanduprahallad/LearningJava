...
public class BaseElementFinder {
    ...
    public WebElement getElementById(String input,long time) throws InterruptedException {
        ...
        By by = By.id(input);
        WebElement byid = driver.findElement(by);
        Thread.sleep(time);
        return byid;
    }
    public WebElement getElementByName(String input,long time)
    {
        ...
        By by = By.name(input);
        WebElement byname= driver.findElement(by);
        return byname;
    }
    public WebElement getElementByClassName(String input,long time)
    {
        ...
        WebElement byClassName= driver.findElement(by);
        return byClassName;
    }
    public WebElement getElementByXpath(String input, long time)
    {
        ...
        WebElement byxpath= driver.findElement(by);
        return byxpath;
    }
    public WebElement getElementByTagName(String input, long time)
    {
        ...
        WebElement byTagname= driver.findElement(by);
        return byTagname;
    }
    public WebElement getElementByCssSelector(String input, long time)
    {
        ...
        WebElement byCss= driver.findElement(by);
        return byCss;
    }
    public WebElement getByLinkText(String input,long time)
    {
        ...
        WebElement byLinkText= driver.findElement(by);
        return byLinkText;
    }
...
//
        ...
        WebElement byPartialLinkText= driver.findElement(by);
